...
class QueryMix extends Component
{
    public $query_mix = array();
    public DbConnection $dbconnection;
    public ImportData $import_data;
    public AggregationFunction $aggregation_function;

    public function getQueryAsMix()
    {
        if ($this->dbconnection->db_type == 'mysql') {
            ...
            $this->query_mix = $query4->fetchAll(PDO::FETCH_ASSOC);
        }
    }
    ...
    {
        return view('livewire.query-mix');
    }
}
